...
export const SYNERGIES: SynergyDef[] = [
  { id:'dbz',         universe:'Dragon Ball Z',       label:'Dragon Ball Z',    color:'#f97316', glow:'#ea580c', icon:'🐉',
    thresholds:[{ count:2, label:'+32% DPS DBZ',dpsBonus:20,globalBonus:0 },{ count:4, label:'+50% DPS +8% global',dpsBonus:50,globalBonus:8 }] },
  { id:'onepiece',    universe:'One Piece',            label:'One Piece',        color:'#f59e0b', glow:'#d97706', icon:'☠',
    thresholds:[{ count:2, label:'+25% DPS One Piece',dpsBonus:15,globalBonus:0 },{ count:3, label:'+35% DPS +5% global',dpsBonus:35,globalBonus:5 }] },
  { id:'naruto',      universe:'Naruto',               label:'Naruto',           color:'#f97316', glow:'#ea580c', icon:'🍃',
    thresholds:[{ count:2, label:'+22% DPS Naruto',dpsBonus:15,globalBonus:0 },{ count:3, label:'+35% DPS',dpsBonus:35,globalBonus:0 }] },
  { id:'pokemon',     universe:'Pokémon',              label:'Pokémon',          color:'#fbbf24', glow:'#f59e0b', icon:'⚡',
    thresholds:[{ count:2, label:'+21% DPS Pokémon',dpsBonus:12,globalBonus:0 },{ count:4, label:'+30% DPS +5% global',dpsBonus:30,globalBonus:5 }] },
  ...
  { id:'poppy',       universe:'Poppy Playtime',       label:'Poppy Playtime',   color:'#4ade80', glow:'#16a34a', icon:'🧸',
    thresholds:[{ count:2, label:'+28% DPS Poppy',dpsBonus:15,globalBonus:0 }] },
  { id:'blackclover', universe:'Black Clover',         label:'Black Clover',     color:'#fbbf24', glow:'#d97706', icon:'🍀',
    thresholds:[{ count:2, label:'+25% DPS Black Clover',dpsBonus:15,globalBonus:0 },{ count:3, label:'+35% DPS',dpsBonus:35,globalBonus:0 }] },
  { id:'brotato',     universe:'Brotato',              label:'Brotato',          color:'#fb923c', glow:'#ea580c', icon:'🥔',
    thresholds:[{ count:2, label:'+22% DPS Brotato',dpsBonus:12,globalBonus:0 }] },
  { id:'tensei',      universe:'Tensei Slime',         label:'Tensei Slime',     color:'#34d399', glow:'#10b981', icon:'🌀',
    thresholds:[{ count:2, label:'+29% DPS Tensei',dpsBonus:20,globalBonus:0 }] },
  { id:'minecraft',   universe:'Minecraft',            label:'Minecraft',        color:'#86efac', glow:'#22c55e', icon:'🟩',
    thresholds:[{ count:2, label:'+22% DPS Minecraft',dpsBonus:12,globalBonus:0 }] },
  ...
  { id:'bleach',      universe:'Bleach',               label:'Bleach',           color:'#60a5fa', glow:'#3b82f6', icon:'⚔',
    thresholds:[{ count:2, label:'+28% DPS Bleach',dpsBonus:18,globalBonus:0 },{ count:4, label:'+45% DPS +6% global',dpsBonus:45,globalBonus:6 }] },
  { id:'fate',        universe:'Fate',                 label:'Fate',             color:'#c084fc', glow:'#9333ea', icon:'👑',
    thresholds:[{ count:2, label:'+25% DPS Fate',dpsBonus:15,globalBonus:0 },{ count:4, label:'+40% DPS +5% global',dpsBonus:40,globalBonus:5 }] },
  ...
  { id:'chillcool',   universe:'Chill&Cool',           label:'Chill&Cool',       color:'#818cf8', glow:'#6366f1', icon:'😎',
    thresholds:[{ count:2, label:'+35% global (mascotte)',dpsBonus:0,globalBonus:8 }] },
